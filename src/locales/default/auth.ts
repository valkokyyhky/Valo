export default {
  ...
  'betterAuth.signin.emailPlaceholder': 'Hey there! Ready to explore?',
  ...
  'betterAuth.signin.passwordPlaceholder': 'Open sesame!',
  ...
  'signin.subtitle': 'Hello, Valko!😊 How\'s your day today?',
